...
And much of what both talks had to skate over now has room to breathe in
**[Topics In Timekeeping](/timekeeping/)** — a growing set of pages on the
questions underneath this one, from
[what limits GNSS time accuracy](/timekeeping/gnss/limits-of-gnss-time-accuracy/)
to [how you would know your clock was still right](/timekeeping/measuring-time/is-my-clock-right/).
