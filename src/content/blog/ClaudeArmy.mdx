...
I knew I could get more done if I could bring more than one agent to bear on my research,
but I couldn't figure out how to keep many agents marching in the same direction.
...
and I no longer have the evidence to check. What I am certain of is that an agent
could pick up somebody else's identity at all, and that is the part I should have
chased at the time.
...
**vestigial `~/.git` left over from that earlier experiment**. My home directory had quietly
...
separating agents into their own directories and inadvertently running a global hive mind the
whole time.
