...
you synchronise clocks you can't touch?**
...
I found it easiest to think about that ladder in things you can hold. Process the
pseudorange signals and your answer sits somewhere inside a **beach ball** — about
a metre. Move to carrier phase and it shrinks to a **softball**. Keep going and
you're down to a **ping-pong ball**. The practical limit is about the size of a
**green pea**, under a centimetre. That's the regime I was trying to work in.
...
deserve. A surveyed antenna position is good to about the width of a pencil
eraser east-west — but the point being surveyed is five centimetres up *inside*
the antenna, and higher still in a choke ring. Locating an object the size of a
dinner plate to the width of a pencil eraser, when the point you care about isn't
visible from outside, is a fair summary of the whole field.

My favourite of the small effects has the best diagnosis attached to it. Watching
...
radius. I ran several agents with specialised roles: research and planning,
Python, driving the instruments and collecting data, and analysis. Some of the
