...
pubDate: 2026-08-12
description: "The same talk, four slides longer — and almost everything new in it came out of writing the pages rather than building the clock"
tags: ["GNSS", "timekeeping", "talks", "AI", "hardware"]
draft: true
---

I gave [this talk again](/blog/sub-nanosecond-at-home-with-gnss-and-ai/) today, a
month after the first outing at NPL. Same argument, same parts list, same clock.
Four more slides.
...
Explaining it to a reader turned out to be a better way to find the holes than
...
The [dress rehearsal recording](https://us06web.zoom.us/rec/share/1zvoQ55HAjh64t1HXOtMuHbLQsf9KlSkImf9Kdp5P-IfeTKznRcYh0pjgsGdbWsc.UuqJBDgil96nxSYb)
is still the July version, so it is missing the four slides above — everything
else in it stands.
