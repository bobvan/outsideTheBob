...
share it where sharing is what you want. The ops agents, for instance, each keep
private lessons in their own store but read and write one shared repository of
host facts — because facts about the homelab belong to the homelab, while how an
agent personally works belongs to that agent.
